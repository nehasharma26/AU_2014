...
public class CustomerCheckOrderStatus {
    ...
    private static final Logger logger = Logger.getLogger(CustomerCheckOrderStatus.class
            .getName());
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 0 ) {
            logger.log(Level.INFO,"usage: CustomerCheckOrderStatus");
            System.exit(1);
        }
        ...
        try {
            ...
            if (message instanceof TextMessage) {
                ...
                System.out.println("Received order status: " + text.getText());
            } else if (message != null) {
                logger.log(Level.INFO,"Received non text message");
            }
