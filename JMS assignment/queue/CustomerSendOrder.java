...
public class CustomerSendOrder{
     ...
     */
    private static final Logger logger = Logger.getLogger(CustomerSendOrder.class.getName());
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            logger.log(Level.INFO,"usage: CustomerSendOrder message");
            System.exit(1);
        }
        ...
        try {
            ...
            sender.send(message);
            logger.log(Level.INFO,"Order Quantity requested: " + message.getText());
